...
<body>
  <h2>當期消費統計</h2>
  <a href="count_year.php">年度消費統計</a>
  <a href="invoice_board.php">上一頁</a>
  <form action="count.php" method="post">
    年份:<input type="number" style="width:50px;" name="year" pattern="[0-9]{4,4}" min="1982" max="2020" required>
    期數:
    <select name="period">
  ...
  <table>
    ...
    if(!empty($_POST['year']) && !empty($_POST['period'])){
      ...
      echo "<tr><td>年月份</td><td>".$_POST['year'].'年'.$month[$_POST['period']]."</td></tr>";
