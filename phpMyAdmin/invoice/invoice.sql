...
(4, 1, '2020-10-31', 5, 'EY', 58489235, 35, '食品酒水', '老虎牙子*1=NT35'),
...
--
ALTER TABLE `invoice`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '發票編號', AUTO_INCREMENT=22;
